 ...
 */
public class KButton1 extends JButton {
        ...
        if (mousePressed == true) {
            ...
            if (iskAllowTab()) {
                ...
                for (int i = 0; i < comp.length; i++) {
                    if (comp[i] instanceof KButton1) {

                        ((KButton1) comp[i]).setSelected(false);
                        ((KButton1) comp[i]).setBorder(BorderFactory.createMatteBorder(0, 0, 0, 0, kIndicatorColor));
                    }
                }
